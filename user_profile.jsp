...
try{
	  ...
	  String qry1="select uid,username,password,reg_date,mobile,email from users where username='"+session.getAttribute("username")+"'";
	  ...
	  if(rs.next())
	  {
		...
		do
		{
			...
			out.println("<th><A class='btn btn-sm btn-success' href='user_profile_edit_code.jsp?uid="+rs.getString("uid")+"'>Edit</th>");					
