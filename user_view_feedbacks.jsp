...
try{
	  ...
	  String qry1="select date_format(fdate,'%d-%m-%Y') as fdate1,feedback,rating,username from feedback where username='"+session.getAttribute("username")+"' order by fid desc";
